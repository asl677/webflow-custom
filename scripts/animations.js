...
(function(exports) {
  ...
  function startMilitaryTime(element) {
    if (!element) {
    ...
    console.log('✅ Military time counter started for element:', element);
  }
...
(function() {
  ...
  setTimeout(() => {
    if (typeof window.lenis === 'undefined' && typeof Lenis === 'undefined') {
      console.log('Lenis not detected, skipping sticky protection');
      return;
    }
